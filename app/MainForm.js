                    ...
                    <Controller
                        ...
                        render={({ field: { onChange, onBlur, value, ref } }) => (
                            <Select
                                ...
                                {
                                    value: 'OneToThreeTimesWeek',
                                    label: 'Тренировки 1-3 раза в неделю',
                                },
                                {
                                    value: 'ThreeToFiveTimesWeek',
                                    label: 'Тренировки 3-5 раза в неделю',
                                },
                                {
                                    value: 'HighLoadDaily',
                                    label: 'Высокие нагрузки каждый день',
                                },
                                {
                                    value: 'ExtremeLoad',
                                    label: 'Экстремальные нагрузки',
                                },
                                ]}
                            />
                        )}
